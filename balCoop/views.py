...
class BalCoopApiView(APIView):
    ...
    def post(self, request):
        ...
        with transaction.atomic():
            ...
            if update_instances:
                BalCoopModel.objects.bulk_update(update_instances, ['periodo', 'mes', 'entidad_RS', 'puc_codigo', 'saldo', 'updated_at'])
    ...
    def post(self, request):
        ...
        for item in data:
            for nit_info in item.get("nit", {}).get("solidaria", []):
                ...
                puc_codes_current = [
                    '100000', '110000', '120000', '140000', '210000', '230000', '240000', '300000', 
                    '310000', '311010', '320000', '330500', '340500', '350000', '415000', '615005', 
                    '615010', '615015', '615020', '615035'
                ]
                puc_codes_previous = ['100000', '140000', '210000', '300000', '230000']
                ...
                indicador_cap_social = (saldos_current['310000'] / saldos_current['100000']) * 100 if saldos_current['100000'] else 0
                indicador_cap_inst = (
                    (saldos_current['311010'] + saldos_current['320000'] + saldos_current['330500'] + saldos_current['340500']) 
                    / saldos_current['100000']
                ) * 100 if saldos_current['100000'] else 0
                ...
                indicador_costos_deposito = (
                    (saldos_current['615005'] + saldos_current['615010'] + saldos_current['615015'] + saldos_current['615020'])
                    / denominator_costos_deposito
                ) * 100 if denominator_costos_deposito else 0
                denominator_credito_banco = (saldos_previous['230000'] + (saldos_current['230000'] / mes_decimal) * 12) / 2
                indicador_credito_banco = (saldos_current['615035'] / denominator_credito_banco) * 100 if denominator_credito_banco else 0

                indicador_disponible = (
                    (saldos_current['110000'] + saldos_current['120000'] - (saldos_current['240000'] * 20 / 100)) 
                    / saldos_current['210000']
                ) * 100 if saldos_current['210000'] else 0
    ...
    def post(self, request):
        ...
        for item in data:
            for nit_info in item.get("nit", {}).get("solidaria", []):
                ...
                puc_codes_current = [
                    '141105', '141205', '144105', '144205', '141110', '141210', '144110', '144210', '141115', 
                    '141215', '144115', '144215', '141120', '141220', '144120', '144220', '141125', '141225', 
                    '144125', '144225', '144805', '145505', '145405', '144810', '145410', '145510', '144815', 
                    '145515', '145415', '144820', '145520', '145420', '144825', '145425', '145525', '146105', 
                    '146205', '146110', '146210', '146115', '146215', '146120', '146220', '146125', '146225', 
                    '140405', '140505', '140410', '140510', '140415', '140515', '140420', '140520', '140425', 
                    '140525', '146905', '146930', '146910', '146935', '146915', '146940', '146920', '146945', 
                    '146925', '146950', '831000', '144500', '145100', '145800', '146500', '140800', '147100'
                ]
